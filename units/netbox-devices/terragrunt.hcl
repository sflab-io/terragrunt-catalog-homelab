...
terraform {
  source = "git::git@github.com:sflab-io/terragrunt-infrastructure-catalog-homelab.git//modules/netbox-devices?ref=${values.version}"
}

dependency "netbox_racks" {
  config_path = values.racks_path
